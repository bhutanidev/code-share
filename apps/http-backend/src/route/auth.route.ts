...
import { createRoomController, joinRoomController, leaveRoomController, logoutController, signinController, signupController } from "../controller/auth.controller"
...
authRouter.post("/logout",attachUser,logoutController)
